...
#if defined(NDEBUG)
# error "Fleacoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Fleacoin Signed Message:\n";
...
//TODO: this isn't identical to fleacoin reference client.
...
static const int64_t nTargetTimespan = 4 * 60 * 60; // Fleacoin: every 4 hours
static const int64_t nTargetTimespanNEW = 60 ; // Fleacoin: every 1 minute
static const int64_t nTargetSpacing = 60; // Fleacoin: 1 minute
...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Fleacoin: This fixes an issue where a 51% attack can change difficulty at will.
...
void ThreadScriptCheck() {
    RenameThread("fleacoin-scriptch");
...
bool ConnectBlock(CBlock& block, CValidationState& state, CBlockIndex* pindex, CCoinsViewCache& view, bool fJustCheck)
{
    ...
    // BIP16 was always active in Fleacoin
...
{
    // Fleacoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
