...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::FLEA);
    nDisplayUnit = settings.value("nDisplayUnit").toInt();
    if(!BitcoinUnits::valid(nDisplayUnit))
        nDisplayUnit = BitcoinUnits::FLEA;
    ...
    if (!settings.contains("strThirdPartyTxUrls"))
        settings.setValue("strThirdPartyTxUrls", "https://fleachain.info/tx/%s|https://chain.so/tx/FLEA/%s");
